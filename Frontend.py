...
root.resizable(0,0)
root.title('BuildDataSets')

title = Label(root,text='BUILD DATA SETS',bg='AntiqueWhite2',font=('bold',13))
...
credits = Label(root,bg='black',fg='white',text='©Developed by Aayushi Ratanghayra',height=3,width=120)
